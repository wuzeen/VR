...
// module
exports.push([module.i, ".crumbs[data-v-e08903a6]{text-decoration:none}.bread[data-v-e08903a6]{font-size:16px}.form-box[data-v-e08903a6]{width:300px;margin-top:50px;margin-left:0;box-shadow:0 0 8px 0 rgba(232,237,250,.9),0 2px 4px 0 rgba(232,237,250,.9);padding:50px 50px 50px 10px}.submit-btn[data-v-e08903a6]{width:220px;margin-left:80px}.submit-btn button[data-v-e08903a6]{width:100%}.product-box[data-v-e08903a6]{padding:28px;width:800px;border:1px solid #e1e1e1;box-shadow:0 0 2px rgba(0,0,0,.1)}.box-param[data-v-e08903a6]{width:100%;margin-top:5px}.param-title[data-v-e08903a6]{height:40px;border-top:none;border-bottom:1px solid #e6e6e6;text-align:center}.param-title h3[data-v-e08903a6]{padding:0 20px;font:normal 16px/40px Microsoft YaHei,arial}.param-tab table[data-v-e08903a6]{table-layout:fixed;width:100%;border-collapse:collapse;border:1px solid #e6e6e6;border-bottom:0 none}.param-tab th[data-v-e08903a6]{width:118px;padding:15px 0 0 20px;background:#fafafa;border-right:1px solid #e6e6e6;text-align:left;font:700 16px/26px Microsoft YaHei,arial;vertical-align:top}.param-tab td[data-v-e08903a6]{width:605px;padding:8px 0 6px;vertical-align:top}.tab-content[data-v-e08903a6]{padding:6px 20px 8px}ul[data-v-e08903a6]{list-style:none}.category li[data-v-e08903a6]{position:relative;padding:2px 0 2px 230px;line-height:26px;_zoom:1;word-wrap:break-word;font:14px/26px Microsoft YaHei,arial;color:#666}.para-name[data-v-e08903a6]{position:absolute;top:2px;left:0;font-weight:700}.para-val[data-v-e08903a6]{position:relative;color:#666;border-bottom:1px dashed #0a50a1}.img-container[data-v-e08903a6]{max-width:50%}.img-container img[data-v-e08903a6]{width:100%}.text[data-v-e08903a6]{width:400px;font-size:15px}.btn[data-v-e08903a6]{margin-left:180px;margin-top:30px}.compare[data-v-e08903a6]{display:block;width:175px;position:absolute;bottom:300px;z-index:9999;top:128px;left:900px}#compare_box[data-v-e08903a6]{width:150px;border:1px solid #c0ccda;box-shadow:0 0 10px #c0ccda}#cancel-btn[data-v-e08903a6]{float:right;width:10px;height:50px;margin-top:40px;margin-left:15px;cursor:pointer}.compare_item[data-v-e08903a6]{float:left;width:90%;height:100px}.compare_item_img[data-v-e08903a6]{width:70%;height:80%;margin-left:10px;margin-top:10px}.compare_btn[data-v-e08903a6]{margin:20px 0 10px 30px}", ""]);
...
var update = __webpack_require__(186)("5e621aba", content, true);
